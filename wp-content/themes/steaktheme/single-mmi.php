    ...
    <?php while (have_posts()):
        ...
        <article class="text-gris">
            ...
            <div class="mb-[2rem] grid grid-cols-1 justify-items-center mx-[4rem]">
                <div class="grid grid-cols-2 gap-5 mx-[2rem]">
                    <div class="">
                    ...
                    <div>
                        ...
                        <img class="w-[12rem]" src="<?php echo wp_get_attachment_url($image_id); ?>" alt="img" />
                    </div>
                </div>
                ...
                <div class="py-[8rem]">
                    ...
                    <div class="grid grid-cols-2 gap-2 py-[8rem]">
                        <div>
                            <?php the_field('p-h3'); ?>
                        ...
                        <div>
                            ...
                            <div>
                                ...
                                <img class="w-[12rem]" src="<?php echo wp_get_attachment_url($image3_id); ?>" alt="img" />
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="grid grid-cols-2 gap-2">
                            <div>
                                ...
                                <div>
                                    ...
                                    <img class="w-[12rem]" src="<?php echo wp_get_attachment_url($image4_id); ?>" alt="img" />
                                </div>
                            </div>
                            <div>
