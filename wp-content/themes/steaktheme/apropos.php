...
<div class="">
    <div class="grid grid-cols-1 justify-items-center gap-0 py-10">
        <div class="">
            ...
            <img class="absolute z-[-1] w-[240px] top-0 left-[180px] md:w-[200px] md:left-[200px] sm:w-[180px] sm:left-[190px] sm:top-[-70px] overflow-hidden" src="<?php
                                                                                                                                                                    echo wp_get_attachment_url(18); ?>" alt="cercle vert blur" />
        </div>
        <div class="items-center sm:mx-[2rem] md:mx-[2rem] mx-[12vw] z-40 pt-[50px] pb-[8rem]">
...
<div class="grid justify-items-center mt-[6rem] z-40">
    <div class="grid grid-cols-2 md:grid-cols-1 sm:grid-cols-1 justify-items-center  items-center justify-center mx-[8rem] lg:mx-[6rem] md:mx-[4rem]">
        <div id="div3">
        ...
        <div class="relative">
            ...
            <img class="w-[20rem] absolute z-[-1] left-[4rem] top-[8rem]" src="<?php echo wp_get_attachment_url(16); ?>" alt="cercle violet" />
        </div>
    ...
    <div class="pb-[4rem]">
        <div class="">
            ...
            <p class="text-[18px] sm:mx-[2rem] font-Paytone text-center">Retrouvez mon travail sur les réseaux sociaux !</p>
        </div>
    </div>
</div>
